#!/bin/bash
#Generated on 2022-04-17 14:01:28 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=c87d9dc1-71f7-42de-9989-194df00ee794&pack=es-es&edition=core;coren;professional;professionaln&aria2=2"
if [ $? != 0 ]; then
